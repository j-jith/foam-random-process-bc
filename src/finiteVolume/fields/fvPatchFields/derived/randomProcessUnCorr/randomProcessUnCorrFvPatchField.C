...
#include "randomProcessUnCorrFvPatchField.H"
...
template<class Type>
List<scalar> randomProcessUnCorrFvPatchField<Type>::randomPhase()
{
...
template<class Type>
scalar randomProcessUnCorrFvPatchField<Type>::generate()
{
    scalar x = 0.0;
...
template<class Type>
randomProcessUnCorrFvPatchField<Type>::randomProcessUnCorrFvPatchField
(
    const fvPatch& p,
...
randomProcessUnCorrFvPatchField<Type>::randomProcessUnCorrFvPatchField
(
    const randomProcessUnCorrFvPatchField<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
template<class Type>
void randomProcessUnCorrFvPatchField<Type>::autoMap
(
...
template<class Type>
void randomProcessUnCorrFvPatchField<Type>::rmap
(
...
)
{
    ...
    const randomProcessUnCorrFvPatchField<Type>& tiptf =
        refCast<const randomProcessUnCorrFvPatchField<Type> >(ptf);
...
template<class Type>
void randomProcessUnCorrFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
    ...
    if (curTimeIndex_ != this->db().time().timeIndex())
    {
        ...
        {
            patchField[facei] = scaleFac_*gustDir_*generate();
        }
        patchField += U0_;
...
template<class Type>
void randomProcessUnCorrFvPatchField<Type>::write(Ostream& os) const
{
